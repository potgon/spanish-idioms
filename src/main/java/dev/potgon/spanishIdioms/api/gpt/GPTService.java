...
public class GPTService {
    ...
    public String generate(String idiom, String guess) {
        String promptMessage = "Te voy a enviar una frase hecha en español y una suposición de lo que puede significar" +
                ...
                "siendo 10 una suposicion perfecta. Para la nota, usa un numero entero sin decimales. " +
                "Esta es la frase hecha: " + idiom + ". Y esta es la suposicion de su significado: " + guess;
